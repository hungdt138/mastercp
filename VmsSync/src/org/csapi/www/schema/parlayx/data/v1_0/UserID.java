 ...
 */
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
    ...
    public static class Factory{
        ...
        */
        public static UserID parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UserID object =
                new UserID();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UserID".equals(type)){
                                ...
                                return (UserID)org.csapi.www.schema.parlayx.data.sync.v1_0.local.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
