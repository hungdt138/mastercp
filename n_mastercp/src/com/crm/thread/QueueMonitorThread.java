...
//		int dbQueueSize = QueueFactory.getDBQueueSize();
		...
		QueueFactory.setQueueSize("queue/CommandRoute", commandRoutingSize);
		QueueFactory.setQueueSize("queue/Alarm", alarmSize);
//		QueueFactory.setQueueSize("vas/DBQueue", dbQueueSize);
		
		alarmMessage.append(sdf.format(new Date()));
		alarmMessage.append("\r\n");
		
		alarmMessage.append("Local queue/CommandRoute queue: ");
		alarmMessage.append(commandRoutingSize);
		alarmMessage.append("\r\n");
		
		alarmMessage.append("Local queue/Alarm queue: ");
