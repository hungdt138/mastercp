...
public class OTPCommandImpl extends CommandImpl
{
			...
			ProvisioningCommand provisioningCommand, CommandMessage request) throws Exception
	{
		...
		try
		{
			...
			String requestStr = "com.crm.provisioning.impl.mobifone.otp.OTPCommandImpl.OTPRequest{spid= " + result.getMerchantId() + ",productid= "
					+ result.getProductId() + "" +
					",isdn= " + result.getIsdn() + ",action= " + action + "}";
			...
			ProvisioningCommand provisioningCommand, CommandMessage request) throws Exception
	{
		...
		try
		{
			...
			String requestStr = "com.crm.provisioning.impl.mobifone.otp.OTPCommandImpl.SubRequest{spid= " + result.getMerchantId() + ",productid= "
					+ result.getProductId() + "" +
					",isdn= " + result.getIsdn() + ",otp= " + otp + "}";
