...
public class MOListenerThread extends DispatcherThread
{
	...
	public int				overloadWaitTime	= 10000;
	...
	public Vector getDispatcherDefinition()
	{
		...
		vtReturn.addElement(ThreadUtil.createIntegerParameter("overloadWaitTime", ""));
	...
	public void fillParameter() throws AppException
	{
		try
		{
			...
			overloadWaitTime = ThreadUtil.getInt(this, "overloadWaitTime", 10000);
		}
