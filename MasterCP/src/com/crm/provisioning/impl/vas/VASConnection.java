...
public class VASConnection extends ProvisioningConnection
{
			...
			throws Exception
	{
		try
		{
			String productName = request.getParameters().getString("sms.params[0]", "");
			...
			// String sku = request.getParameters().getString("vas.sku", "");
			int commandId = 1;
			...
			ActivationStatusSoap res = serviceSoap.provisioning(sourceAddress, sku, commandId);
