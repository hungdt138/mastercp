 ...
 * -------------------------------------
 */
package com.crm.provisioning.impl.vms;
...
//			if (!msg.equals("") && message.getParameters().getString("serviceId").equals("1303042000071764"))
//			{
//				param.setMessage(msg);
//			}
//			else
//			{
				param.setMessage(message.getMsgContent());
//			}
			...
			throws Exception
	{
		try
		{
			...
			param.setSubject(message.getSubject());
			// param.setReceiptRequest(sim);
			param.setSenderAddress(message.getServiceAddress());
			URI targetURL = new URI(message.getUrl());
	...
	public static String getLink(int count)
	{
		String msg = "";
		switch (count)
		{
		case 5:
			// Vegas Online 1.1.4 - Giao diện 3D đỉnh cao
			msg = "Link tai game cua ban la: http://goo.gl/kX1Wp6";
			break;
		case 13:
			// pacman
			msg = "Link tai game cua ban la: http://goo.gl/XSXoDB";
			break;
		case 18:
			// day hop
			msg = "Link tai game cua ban la: http://goo.gl/3DszP0";
			break;
		case 25:
			msg = "Link tai game cua ban la: http://goo.gl/m5Py7Z";
			break;
		case 30:
			msg = "Link tai game cua ban la: http://goo.gl/9IJFcZ";
			break;
		case 35:
			msg = "Link tai game cua ban la: http://goo.gl/i3C5g7";
			break;
		default:
			break;
		}
