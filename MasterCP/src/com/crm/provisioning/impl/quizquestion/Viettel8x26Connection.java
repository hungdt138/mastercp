...
//		String test = connection.sendSMS(1, "8626", "", "SS", "", 
//				1, "Chuc mung!Ban la nguoi co so diem cao nhat trong vong choi nay va da chien thang iPod sanh dieu.Chung toi se lien lac voi ban de nhan giai thuong", 1, 0, 0);
//	}
}
