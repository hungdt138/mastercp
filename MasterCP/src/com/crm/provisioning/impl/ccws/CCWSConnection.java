...
public class CCWSConnection extends ProvisioningConnection
{
	...
	public SubscriberRetrieve getSubscriber(String isdn, int queryLevel) throws RemoteException
	{
		return binding.retrieveSubscriberWithIdentityNoHistory(isdn, null, queryLevel);
	}

	public SubscriberEntity getSubscriberInfor(String isdn, int queryLevel) throws RemoteException
	{
