...
public class CommandMessage extends BaseMessage
{
	...
	private String				url					= "";
	//0 Charge - 1 free
	private int					vnmChargeMode		= 0;
	
	//0 SMS - 1 Wap
	private int					vnmDeliveryMode     = 0;
	...
	public void copyTo(CommandMessage destination)
	{
		...
		destination.setMsgContent(msgContent);
		...
		destination.setVnmChargeMode(vnmChargeMode);
		destination.setVnmDeliveryMode(vnmDeliveryMode);
		destination.setVnmProduct(vnmProduct);
		destination.setRetryCounter(retryCounter);
	}
	...
	public String toLogString()
	{
		...
		result.append(" | vnmDeliveryMode = ");
		result.append(vnmDeliveryMode);
		result.append(" | vnmChargeMode = ");
		result.append(vnmChargeMode);
		result.append(" | vnmProduct = ");
		result.append(vnmProduct);
	...
	public int getVnmChargeMode()
	{
		return vnmChargeMode;
	}

	public void setVnmChargeMode(int vnmChargeMode)
	{
		this.vnmChargeMode = vnmChargeMode;
	}

	public int getVnmDeliveryMode()
	{
		return vnmDeliveryMode;
	}

	public void setVnmDeliveryMode(int vnmDeliveryMode)
	{
		this.vnmDeliveryMode = vnmDeliveryMode;
	}
