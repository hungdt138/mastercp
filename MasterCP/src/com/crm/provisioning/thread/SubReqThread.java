 ...
 *
 */
public class SubReqThread extends CommandThread
{
	...
	public Vector getParameterDefinition()
	{
		...
		vtReturn.add(ThreadUtil.createTextParameter("subLink", 500, "Link request OTP"));
	...
	public void fillDispatcherParameter() throws AppException
	{
		...
		subLink = ThreadUtil.getString(this, "otpLink", false, "");
	...
	public void initProvisioningParameters() throws Exception
	{
		try
		{
			...
			parameters.setString("subRequestLink", subLink);
