...
public class OSACallbackThread extends DispatcherThread
{
	...
	public Vector getDispatcherDefinition()
	{
		...
		vtReturn.addElement(ThreadUtil.createIntegerParameter("logQueueInterval", "Time interval to show local queue size, in second."));
	...
	public void doProcessSession() throws Exception
	{
		try
		{
			...
			if ((server == null) || server.isClosed())
			{
				server = new ServerSocket(callbackPort);
			}
