package com.crm.provisioning.connection.epos;
...
public class EposCommandImpl extends CommandImpl {
	...
	public void prepaidRegistration(CommandInstance instance, ProvisioningCommand provisioningCommand, CommandMessage request) throws Exception
	{
		
	}
	
	public void checkSTK(CommandInstance instance, ProvisioningCommand provisioningCommand, CommandMessage request) throws Exception
	{
