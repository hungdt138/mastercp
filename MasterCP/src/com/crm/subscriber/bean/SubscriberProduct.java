...
public class SubscriberProduct implements Serializable
{
	...
	{
		return (barringStatus == Constants.USER_ACTIVE_STATUS) && (supplierStatus == Constants.SUPPLIER_ACTIVE_STATUS);
	}

	public boolean isBarring()
	{
		return (barringStatus == Constants.USER_BARRING_STATUS) || (supplierStatus == Constants.SUPPLIER_BARRING_STATUS);
	}

	public boolean isCancel()
	{
		return (barringStatus == Constants.USER_CANCEL_STATUS) && (supplierStatus == Constants.SUPPLIER_CANCEL_STATUS);
	}
