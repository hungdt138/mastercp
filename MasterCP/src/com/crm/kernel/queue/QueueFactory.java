...
public class QueueFactory
{
	...
	public static String									ALARM_QUEUE				= "test/Alarm";
	...
	public static synchronized void closeQueue(QueueBrowser browser) throws Exception
	{
		try
		{
			if (browser != null)
	...
	public static synchronized void closeQueue(MessageConsumer consumer) throws Exception
	{
		try
		{
			if (consumer != null)
	...
	public static synchronized void closeQueue(QueueReceiver queueReceiver) throws Exception
	{
		try
		{
	...
	public static synchronized void closeQueue(MessageProducer producer)
	{
		try
		{
			if (producer != null)
	...
	public static synchronized void closeQueue(QueueConnection connection)
	{
		try
		{
			if (connection != null)
	...
	public static synchronized void closeQueue(QueueSession queueSession)
	{
		try
		{
	...
	public static synchronized Queue createQueue() throws Exception
	{
		throw new AppException("not-implemented");
	}

	public static void sendMessage(QueueSession queueSession, Queue queue, Message message, long timeout) throws Exception
	{
	...
	public static void sendMessage(QueueSession queueSession, Queue queue, Message message) throws Exception
	{
		sendMessage(queueSession, queue, message, 0);
	}

	public static void sendMessage(QueueSession queueSession, String queueName, Message message)
			throws Exception
	{
		sendMessage(queueSession, getQueue(queueName), message);
	}

	public static void sendObjectMessage(QueueSession queueSession, Queue queue, Serializable messageContent)
			throws Exception
	{
		sendMessage(queueSession, queue, createObjectMessage(queueSession, messageContent));
	}

	public static void sendObjectMessage(QueueSession queueSession, String queueName, Serializable messageContent)
			throws Exception
	{
		sendMessage(queueSession, getQueue(queueName), createObjectMessage(queueSession, messageContent));
	}

	public static void attachStatistic(CommandMessage request)
	{
		commandStatiticQueue.offer(request);
	}

	public static CommandMessage detachStatistic()
	{
		return commandStatiticQueue.poll();
	}
