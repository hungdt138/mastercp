...
{
	public static final char[]	_HEX_DIGITS		= { '0', '1', '2', '3', '4',
			...
			String end, Map<String, String> values)
	{
		...
		if ((s == null) || (begin == null) || (end == null) || (values == null) || (values
				.size() == 0))
		{
	...
	{
		if ((Validator.isNull(s)) || (delimiter == null) || (delimiter
	...
	public static Vector toStringVector(String strSource, String strSeparator)
	{
		...
		if (iLastIndex <= strSource.length())
			vtReturn.addElement(strSource.substring(iLastIndex, strSource
					.length()).trim());
		return vtReturn;
	}
