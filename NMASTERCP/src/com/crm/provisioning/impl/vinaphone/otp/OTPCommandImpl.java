...
public class OTPCommandImpl extends CommandImpl
{
			...
			ProvisioningCommand provisioningCommand, CommandMessage request) throws Exception
	{
		...
		try
		{
			...
			String requestStr = "com.crm.provisioning.impl.vinaphone.otp.OTPCommandImpl.OTPRequest{spid= " + result.getMerchantId() + ",productid= "
					+ result.getProductId() + "" +
			...
			ProvisioningCommand provisioningCommand, CommandMessage request) throws Exception
	{
		...
		try
		{
			...
			String requestStr = "com.crm.provisioning.impl.vinaphone.otp.OTPCommandImpl.SubRequest{spid= " + result.getMerchantId() + ",productid= "
					+ result.getProductId() + "" +
