...
public class SubscriberProductImpl
{
	 ...
	 * @throws Exception
	 */
	public static SubscriberProduct[] getUnterminated(String isdn) throws Exception
	{
		Connection connection = null;
	 ...
	 * @throws Exception
	 */
	public static SubscriberProduct[] getUnterminated(Connection connection, String isdn) throws Exception
	{
	 ...
	 * @throws Exception
	 */
	public static SubscriberProduct[] getBarring(Connection connection, String isdn) throws Exception
	{
	...
	public static List<SubscriberProduct> getListActive(long subscriberId, String isdn) throws Exception
	{
		Connection connection = null;
			...
			throws Exception
	{
		...
		try
		{
			...
			Date expirationDate = DateUtil.addDate(expiration.getTime(), subscriptionUnit, subscriptionPeriod);
	...
	public static void setSubscriptionComplete(long subProductId) throws Exception
	{
		Connection connection = null;
		try
		{
	...
	public static void setSubscriptionComplete(Connection connection, long subProductId) throws Exception
	{
		PreparedStatement stmtSubscription = null;
		try
		{
	...
	public static boolean checkFirstTime(String isdn, long productId, Connection connection)
	{
	...
	public static boolean checkFirstTime(String isdn, long productId) throws Exception
	{
		Connection connection = null;
	...
	public static boolean isFirstTimeRegister(String isdn, long productId) throws Exception
	{
		Connection connection = null;
		try
		{
	...
	public static boolean checkSecondTimeInDay(String isdn, long productid, Connection connection)
	{
	...
	public static boolean isSecondTimeInDay(String isdn, long productId) throws Exception
	{
		Connection connection = null;
		try
		{
	...
	public static SubscriberGoService getGoServiceData(String isdn, long productId, Connection connection)
	{
		...
		try
		{
			String sql = "select * from subscriberproduct where isdn = ? and productid= ? and supplierstatus = ? and registerdate > trunc(sysdate)";
	...
	public static SubscriberGoService getGoServiceData(String isdn, long productId) throws Exception
	{
		Connection connection = null;
		try
		{
	...
	public static void registerGoService(
			long userId, String userName, long subscriberId, String isdn, int subscriberType
			, long productId, long campaignId, String languageId, boolean includeCurrentDay,
			long score, long lastQuestionId, long numberofQuestion, int isFirstTime) throws Exception
	{
		Connection connection = null;
		...
		try
		{
			...
			registerGoService(connection, userId, userName, subscriberId, isdn, subscriberType, productId, campaignId, languageId,
	...
	public static void registerGoService(Connection connection, long userId, String userName, long subscriberId,
			String isdn, int subscriberType, long productId, long campaignId,
			String languageId, boolean includeCurrentDay,
			long score, long lastQuestionId, long numberofQuestion, int isFirstTime) throws Exception
	{
		SubscriberProduct subscriberProduct = null;
		...
		try
		{
			...
			if (subscriberProduct != null)
			{
				SubscriberProductImpl.unregisterGoService(userId, userName, subscriberProduct.getSubProductId(), subscriberProduct.getProductId());
			}
			...
			String sql = "Insert into SubscriberProduct " +
					...
					"     , subscriberId, isdn, subscriberType, productId, languageId " +
					"     , registerDate, termDate, expirationDate, graceDate, barringStatus, supplierStatus, CampaignId" +
					"	  , score, LASTQUESTIONID,NUMOFQUESTION,ISFIRSTTIME) " +
					"Values " +
					"     (?, ?, ?, sysDate, sysDate " +
					"     , ?, ?, ?, ?, ? " +
					"     , ?, ?, ?, ?, ?, ?, ?" +
	...
	public static void unregisterGoService(long userId, String userName, long subProductId, long productId) throws Exception
	{
		Connection connection = null;
		...
		try
		{
			...
			unregisterGoService(connection, userId, userName, subProductId, productId);
		}
		catch (Exception e)
		{
			throw e;
	...
	public static void unregisterGoService(Connection connection, long userId, String userName, long subProductId, long productId)
			throws Exception
	{
		// SubscriberProduct subscriberProduct = null;
	...
	public static String getQuestion(long questionId, long productid) throws Exception
	{
		Connection connection = null;
		try
		{
			connection = Database.getConnection();
			return getQuestion(questionId, productid, connection);
		}
		finally
		{
			Database.closeObject(connection);
	...
	public static String getQuestion(long questionId, long productid, Connection connection) throws Exception
	{
		String strQuestion = "";
		...
		try
		{
			...
			stmtQuest.setLong(1, questionId);
	...
	public static String getAnswer(long questionId, long productid) throws Exception
	{
		Connection connection = null;
		try
		{
	...
	public static String getAnswer(long questionId, long productid, Connection connection) throws Exception
	{
		String answer = "";
	...
	public static void updateScoreGoService(String isdn, long productid, long score, long lastQuestionId, long numberofquestion)
	{
		Connection connection = null;
		try
		{
			connection = Database.getConnection();
			updateScoreGoService(isdn, productid, score, lastQuestionId, numberofquestion, connection);
		}
		catch (Exception e)
		{
			e.printStackTrace();
	...
	public static void updateScoreGoService(String isdn, long productid, long score, long lastQuestionId, long numberofquestion, Connection connection)
			throws Exception
	{
		PreparedStatement stmtUpdateScore = null;
		try
		{
			String sql = "update subscriberproduct set score = ? , lastquestionid = ?, numofquestion = ?" +
	...
	public static int randomizeQuestion(long productid)
	{
		...
		try
		{
			...
			String sql = " select count(*) as total from questiontable where productid = ?";
	...
	public static int getTotalQuestion(long productId, Connection connection)
	{
		...
		try
		{
			String sqlTotalQuestion = "select count(*) total from questiontable where productid = ?";
	...
	public static boolean isUnregisterInDay(String isdn, long productid) throws Exception
	{
		Connection connection = null;
		try
		{
	...
	public static boolean isUnregisterInDay(String isdn, long productid, Connection connection) throws Exception
	{
	...
	public static void insertSms(String isdn, long productid, Connection connection, String content,
			long questionid, String serviceAddress, Date sendDate) throws Exception
	{
		...
		try
		{
			...
			stmtInsert.setLong(1, Database.getSequence(connection, "send_sms_go_seq"));
	...
	public static void insertSms(String isdn, long productid, String content, long questionid, String serviceAddress, Date sendDate) throws Exception
	{
		Connection connection = null;
		try
		{
			...
			insertSms(isdn, productid, connection, content, questionid, serviceAddress, sendDate);
		}
		catch (Exception e)
		{
			throw e;
	...
	public static boolean isSendQuestion(String isdn, long productid) throws Exception
	{
		Connection connection = null;
		try
		{
	...
	public static boolean isSendQuestion(String isdn, long productid, Connection connection) throws Exception
	{
		boolean result = true;
		String strSQL = "Select count(*) as total from send_sms_go where isdn = ? and productid =? and nvl(sendflag,0) = 0 and senddate > trunc(sysdate)";
	...
	public static int getNumberOfCode(String isdn, long productid) throws Exception
	{
		Connection connection = null;
		try
		{
	...
	public static int getNumberOfCode(String isdn, long productid, Connection connection)
	{
