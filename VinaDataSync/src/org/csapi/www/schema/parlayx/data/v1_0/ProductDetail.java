...
public class ProductDetail implements org.apache.axis2.databinding.ADBBean
{
	/*
	 * This type was generated from the piece of schema that had name =
	 * ProductDetail Namespace URI =
	 * http://www.csapi.org/schema/parlayx/data/v1_0 Namespace Prefix = ns2
	 */
			...
			org.apache.axis2.databinding.ADBException
	{
		...
		if ((namespace != null) && (namespace.trim().length() > 0))
		{
			...
			else
			{
				...
				xmlWriter
						.writeStartElement(prefix, parentQName.getLocalPart(), namespace);
		...
		if (serializeType)
		{
			...
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":ProductDetail", xmlWriter);
			}
			else
			{
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", "ProductDetail", xmlWriter);
			}
		...
		if (localOperationTimeTracker)
		{
			...
			if (!namespace.equals(""))
			{
				...
				if (prefix == null)
				{
					...
					xmlWriter
							.writeStartElement(prefix, "operationTime", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
		...
		if (localSubscriptionValidTimeTracker)
		{
			...
			if (!namespace.equals(""))
			{
				...
				if (prefix == null)
				{
					...
					xmlWriter
							.writeStartElement(prefix, "subscriptionValidTime", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
				...
				{
					xmlWriter
							.writeStartElement(namespace, "subscriptionValidTime");
				}
		...
		if (localSubscriptionAddtionalInfoTracker)
		{
			...
			if (!namespace.equals(""))
			{
				...
				if (prefix == null)
				{
					...
					xmlWriter
							.writeStartElement(prefix, "subscriptionAddtionalInfo", namespace);
					xmlWriter.writeNamespace(prefix, namespace);
					xmlWriter.setPrefix(prefix, namespace);
				...
				{
					xmlWriter
							.writeStartElement(namespace, "subscriptionAddtionalInfo");
				}
			...
			throws org.apache.axis2.databinding.ADBException
	{
		...
		elementList.add(new javax.xml.namespace.QName("", "notifySPURL"));

		if (localNotifySPURL != null)
		{
			elementList.add(org.apache.axis2.databinding.utils.ConverterUtil
					.convertToString(localNotifySPURL));
		}
		else
		{
			throw new org.apache.axis2.databinding.ADBException("notifySPURL cannot be null!!");
		...
		if (localOperationTimeTracker)
		{
			elementList.add(new javax.xml.namespace.QName("", "operationTime"));

			if (localOperationTime != null)
			{
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localOperationTime));
			}
			else
			{
				throw new org.apache.axis2.databinding.ADBException("operationTime cannot be null!!");
		...
		{
			elementList
					.add(new javax.xml.namespace.QName("", "subscriptionValidTime"));

			if (localSubscriptionValidTime != null)
			{
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localSubscriptionValidTime));
			}
			else
			{
				throw new org.apache.axis2.databinding.ADBException("subscriptionValidTime cannot be null!!");
		...
		{
			elementList
					.add(new javax.xml.namespace.QName("", "subscriptionAddtionalInfo"));

			if (localSubscriptionAddtionalInfo != null)
			{
				elementList
						.add(org.apache.axis2.databinding.utils.ConverterUtil
								.convertToString(localSubscriptionAddtionalInfo));
			}
			else
			{
				throw new org.apache.axis2.databinding.ADBException("subscriptionAddtionalInfo cannot be null!!");
	...
	public static class Factory
	{
		 ...
		 * outer element
		 */
		public static ProductDetail parse(
				javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception
		{
			ProductDetail object = new ProductDetail();
			...
			try
			{
						...
						.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null)
				{
					...
					if (fullTypeName != null)
					{
						...
						if (!"ProductDetail".equals(type))
						{
							...
							return (ProductDetail) org.csapi.www.schema.parlayx.data.sync.v1_0.local.ExtensionMapper
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "notifySPURL")
						.equals(reader.getName()))
				{

					java.lang.String content = reader.getElementText();

					object.setNotifySPURL(org.apache.axis2.databinding.utils.ConverterUtil
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "operationTime")
						.equals(reader.getName()))
				{

					java.lang.String content = reader.getElementText();

					object.setOperationTime(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "subscriptionValidTime")
						.equals(reader.getName()))
				{

					java.lang.String content = reader.getElementText();

					object.setSubscriptionValidTime(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "subscriptionAddtionalInfo")
						.equals(reader.getName()))
				{

					java.lang.String content = reader.getElementText();

					object.setSubscriptionAddtionalInfo(org.apache.axis2.databinding.utils.ConverterUtil
							.convertToString(content));
