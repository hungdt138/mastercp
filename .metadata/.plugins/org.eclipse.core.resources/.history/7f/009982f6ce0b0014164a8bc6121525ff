...
public class SdpVmsCommandImp extends CommandImpl
{
			...
			throws Exception
	{
		...
		try
		{
			...
			String requestStr = "[SMS SEND] ID = " + sessionId + ",SPID = " + spId + ",SID = " + serviceId + ",PRODUCTID = " + productId + "" +
					",ISDN = "+result.getIsdn()+",DESC = " + description + ",CONTENT = " + result.getMsgContent() + "";
			...
			String respStr = "[SMS RECEIVE] ID = " + sessionId + ", IDENTIFIER = " + identifier + ", STATUS = success, COST = " + costTime + "";
