...
public class OTPCommandImpl extends CommandImpl
{
			...
			ProvisioningCommand provisioningCommand, CommandMessage request) throws Exception
	{
		...
		try
		{
			...
			long sessionId = setRequest(instance, request, getLogRequest("com.crm.provisioning.impl.vinaphone.otp.OTPCommandImpl.OTPRequest ", result.getIsdn(), result.getMerchantId(), result.getProductId(), action));
			...
			ProvisioningCommand provisioningCommand, CommandMessage request) throws Exception
	{
		...
		try
		{
			...
			long sessionId = setRequest(instance, request, getLogRequest("com.crm.provisioning.impl.vinaphone.otp.OTPCommandImpl.SubRequest ", result.getIsdn(), result.getMerchantId(), result.getProductId(), otp));
