...
public class ErrorCode
{
	...
	public static String getErrorDetail(String errorcode)
	{
		...
		if (errorcode.equals(Integer.valueOf(SUCCESS)))
		{
			return "Success";
		}
		else if (errorcode.equals(Integer.valueOf(ERROR)))
		{
			return "Error";
		}
		...
		{
			return "Subscriber is not active or lock";
		}
	...
	public static int getResultByCause(String cause)
	{
		if (cause.equals("") || cause == null)
		{
			return ERROR;
		}
